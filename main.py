...
dep = st.selectbox('Выберите город отправления', ('Moscow', 'Krasnoyarsk', 'Saint Petersburg',
                                                  'Barnaul', 'Astrakhan', 'Kazan', 'Kaliningrad',
                                                  'Abakan', 'Voronezh', 'Yuzhno-Sakhalinsk', 'Ekaterinburg',
                                                  'Krasnodar', 'Antalya', 'Vienna', 'Dubai'))
...
arr= st.selectbox('Выберите город прибытия', ('Moscow', 'Krasnoyarsk', 'Saint Petersburg',
                                                  'Barnaul', 'Astrakhan', 'Kazan', 'Kaliningrad',
                                                  'Abakan', 'Voronezh', 'Yuzhno-Sakhalinsk', 'Ekaterinburg',
                                                  'Krasnodar', 'Antalya', 'Vienna', 'Dubai'))
